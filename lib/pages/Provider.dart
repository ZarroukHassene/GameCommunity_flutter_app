...
class ProductProvider with ChangeNotifier {
  ...
  Future<void> addToCart(Product product) async {
    try {
      ...
      final url = Uri.parse('http://localhost:9090/api/cart/add'); // Update with your API URL
  ...
  Future<void> addProduct(Product product) async {
    ...
    try {
      final url = Uri.parse('http://localhost:9090/api/products/'); // Update with your API URL
  ...
  Future<void> removeProduct(String id) async {
    try {
      final url = Uri.parse('http://localhost:9090/api/products/$id'); // Update with your API URL
