...
import 'package:gamefan_app/screens/user_list.dart';
import 'package:gamefan_app/screens/feedback_screen.dart';
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => UserListScreen(currentUserId: newUser!.id)),
                );
              },
            ),
            ListTile(
